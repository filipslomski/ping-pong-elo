...
var author$project$Leaderboard$Asc = {$: 'Asc'};
var author$project$Leaderboard$SPosition = {$: 'SPosition'};
...
var author$project$Palette$colorA1 = A3(mdgriffith$elm_ui$Element$rgb255, 130, 143, 152);
...
var author$project$App$renderLogo = A2(
	mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$height(mdgriffith$elm_ui$Element$fill),
			mdgriffith$elm_ui$Element$Font$color(author$project$Palette$colorA1),
...
var author$project$App$renderMenu = function (app) {
	return A2(
...
var author$project$Leaderboard$SHighestRating = {$: 'SHighestRating'};
var author$project$Leaderboard$SName = {$: 'SName'};
var author$project$Leaderboard$SRating = {$: 'SRating'};
var author$project$Leaderboard$SWinRatio = {$: 'SWinRatio'};
var author$project$Leaderboard$SWinStreak = {$: 'SWinStreak'};
var author$project$Leaderboard$Sort = F2(
	function (a, b) {
		return {$: 'Sort', a: a, b: b};
	});
var author$project$Palette$colorB1 = A3(mdgriffith$elm_ui$Element$rgb255, 237, 222, 202);
var mdgriffith$elm_ui$Internal$Model$Px = function (a) {
	return {$: 'Px', a: a};
};
var mdgriffith$elm_ui$Element$px = mdgriffith$elm_ui$Internal$Model$Px;
var author$project$Leaderboard$ratingColStyle = _List_fromArray(
	[
...
var author$project$Leaderboard$numCol = function (v) {
	return A2(
		mdgriffith$elm_ui$Element$el,
...
var author$project$Leaderboard$renderHighest = function (r) {
	return author$project$Leaderboard$numCol(r.highestRating);
};
...
var author$project$Leaderboard$renderRating = function (r) {
	return author$project$Leaderboard$numCol(r.rating);
};
var author$project$Leaderboard$floatCol = function (v) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		author$project$Leaderboard$ratingColStyle,
		A2(
...
var author$project$Leaderboard$round2 = function (n) {
	return elm$core$Basics$round(n * 100) / 100;
};
var author$project$Leaderboard$renderWinRatio = function (r) {
	return author$project$Leaderboard$floatCol(
		author$project$Leaderboard$round2(
			r.victories / A2(elm$core$Basics$max, 1, r.matches)));
};
var author$project$Leaderboard$renderWinStreak = function (r) {
	return author$project$Leaderboard$numCol(r.winStreak);
};
var author$project$Leaderboard$Desc = {$: 'Desc'};
var author$project$Leaderboard$reverseSort = function (d) {
	return _Utils_eq(d, author$project$Leaderboard$Asc) ? author$project$Leaderboard$Desc : author$project$Leaderboard$Asc;
};
var elm$core$List$sortWith = _List_sortWith;
var author$project$Leaderboard$sortByField = F2(
	function (field, dir) {
		var cmpField = F2(
			function (r1, r2) {
				switch (field.$) {
					case 'SPosition':
						return A2(elm$core$Basics$compare, r1.position, r2.position);
					case 'SName':
						return A2(elm$core$Basics$compare, r1.name, r2.name);
					case 'SRating':
						return A2(elm$core$Basics$compare, r1.rating, r2.rating);
					case 'SMatches':
						return A2(elm$core$Basics$compare, r1.matches, r2.matches);
					case 'SWinStreak':
						return A2(elm$core$Basics$compare, r1.winStreak, r2.winStreak);
					case 'SHighestRating':
						return A2(elm$core$Basics$compare, r1.highestRating, r2.highestRating);
					case 'SVictories':
						return A2(elm$core$Basics$compare, r1.victories, r2.victories);
					default:
						return A2(
							elm$core$Basics$compare,
							r1.victories / A2(elm$core$Basics$max, 1, r1.matches),
							r2.victories / A2(elm$core$Basics$max, 1, r2.matches));
				}
			});
		return elm$core$List$sortWith(
			F2(
				function (r1, r2) {
					var _n0 = A2(cmpField, r1, r2);
					switch (_n0.$) {
						case 'LT':
							return _Utils_eq(dir, author$project$Leaderboard$Asc) ? elm$core$Basics$LT : elm$core$Basics$GT;
						case 'EQ':
							return elm$core$Basics$EQ;
						default:
							return _Utils_eq(dir, author$project$Leaderboard$Asc) ? elm$core$Basics$GT : elm$core$Basics$LT;
					}
				}));
	});
var author$project$Palette$colorA3 = A3(mdgriffith$elm_ui$Element$rgb255, 47, 65, 76);
var author$project$Palette$colorA4 = A3(mdgriffith$elm_ui$Element$rgb255, 28, 50, 64);
var author$project$Palette$colorC4 = A3(mdgriffith$elm_ui$Element$rgb255, 28, 70, 50);
...
var author$project$Leaderboard$renderLeaderboard = function (st) {
	var thRight = function (title) {
		return A2(
			mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[mdgriffith$elm_ui$Element$centerY, mdgriffith$elm_ui$Element$alignRight]),
	...
	var headerStyle = function (sfield) {
		return _Utils_ap(
			_List_fromArray(
				[
					...
					A2(
						...
						sfield,
						_Utils_eq(st.sortBy, sfield) ? author$project$Leaderboard$reverseSort(st.sortDir) : author$project$Leaderboard$Asc)),
			...
			_Utils_eq(st.sortBy, sfield) ? _List_fromArray(
		...
		[
			...
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$Border$color(author$project$Palette$colorA3)
				]),
			{
				label: A2(
				...
				placeholder: elm$core$Maybe$Just(
					A2(
						...
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$Font$color(author$project$Palette$colorA3)
							]),
						A2(
							mdgriffith$elm_ui$Element$el,
							_List_Nil,
			...
			_List_fromArray(
				[
					...
					A2(
						...
						800,
						A2(mdgriffith$elm_ui$Element$maximum, 1100, mdgriffith$elm_ui$Element$fill))),
					mdgriffith$elm_ui$Element$Background$color(author$project$Palette$colorC4),
					mdgriffith$elm_ui$Element$padding(10),
					mdgriffith$elm_ui$Element$spacing(10),
					mdgriffith$elm_ui$Element$centerX,
					mdgriffith$elm_ui$Element$Border$color(author$project$Palette$colorC4),
					mdgriffith$elm_ui$Element$Border$width(1),
				...
				]),
			{
				columns: _List_fromArray(
					[
						...
						header: A2(
							mdgriffith$elm_ui$Element$el,
							headerStyle(author$project$Leaderboard$SPosition),
							thRight('#')),
						view: author$project$Leaderboard$renderPosition,
						width: mdgriffith$elm_ui$Element$px(25)
					},
						{
						header: A2(
							mdgriffith$elm_ui$Element$el,
							headerStyle(author$project$Leaderboard$SName),
							th('Player')),
						view: author$project$Leaderboard$renderPlayer,
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: A2(
							mdgriffith$elm_ui$Element$el,
							headerStyle(author$project$Leaderboard$SRating),
							thRight('Rating')),
						view: author$project$Leaderboard$renderRating,
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: A2(
							mdgriffith$elm_ui$Element$el,
							headerStyle(author$project$Leaderboard$SWinStreak),
							thRight('Win streak')),
						view: author$project$Leaderboard$renderWinStreak,
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: A2(
							mdgriffith$elm_ui$Element$el,
							headerStyle(author$project$Leaderboard$SHighestRating),
							thRight('Highest')),
						view: author$project$Leaderboard$renderHighest,
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: A2(
							mdgriffith$elm_ui$Element$el,
							headerStyle(author$project$Leaderboard$SWinRatio),
							thRight('Win ratio')),
						view: author$project$Leaderboard$renderWinRatio,
						width: mdgriffith$elm_ui$Element$fill
					}
					]),
				data: A3(
					author$project$Leaderboard$sortByField,
					st.sortBy,
					st.sortDir,
					A2(
						elm$core$List$filter,
...
var author$project$App$renderLayout = function (app) {
	return A2(
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$Background$color(author$project$Palette$colorA3)
			]),
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							author$project$App$renderLogo,
							author$project$App$renderMenu(app)
						])),
					A2(
					mdgriffith$elm_ui$Element$column,
					_List_fromArray(
...
var author$project$App$renderApp = function (app) {
	return {
		body: _List_fromArray(
			[
				author$project$App$renderLayout(app)
			]),
		title: app.pageTitle
	};
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$list(
		A2(
			...
			A2(elm$json$Json$Decode$field, 'url', elm$json$Json$Decode$string))))({"versions":{"elm":"0.19.0"},"types":{"message":"App.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Leaderboard.Rating":{"args":[],"type":"{ name : String.String, rating : Basics.Int, matches : Basics.Int, winStreak : Basics.Int, highestRating : Basics.Int, rankImage : String.String, victories : Basics.Int, position : Basics.Int }"},"Player.Match":{"args":[],"type":"{ victorious : String.String, defeated : String.String }"},"Player.State":{"args":[],"type":"{ matches : List.List Player.Match, playerName : String.String, playerPosition : Basics.Int, playerRating : Basics.Int, playerRankImage : String.String }"}},"unions":{"App.Msg":{"args":[],"tags":{"LeaderboardMsg":["Leaderboard.Msg"],"PlayerMsg":["Player.Msg"],"UrlChangeAttempt":["Browser.UrlRequest"],"UrlChanged":["Url.Url"]}},"Leaderboard.Msg":{"args":[],"tags":{"Sort":["Leaderboard.SortBy","Leaderboard.SortDir"],"Filter":["String.String"],"GotRatings":["Result.Result Http.Error (List.List Leaderboard.Rating)"]}},"Player.Msg":{"args":[],"tags":{"GotPlayer":["Result.Result Http.Error Player.State"]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Leaderboard.SortBy":{"args":[],"tags":{"SPosition":[],"SName":[],"SRating":[],"SMatches":[],"SWinStreak":[],"SHighestRating":[],"SVictories":[],"SWinRatio":[]}},"Leaderboard.SortDir":{"args":[],"tags":{"Asc":[],"Desc":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}}}}})}});}(this));
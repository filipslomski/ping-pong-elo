...
var author$project$Leaderboard$SMatches = {$: 'SMatches'};
var author$project$Leaderboard$SName = {$: 'SName'};
var author$project$Leaderboard$SRating = {$: 'SRating'};
var author$project$Leaderboard$SVictories = {$: 'SVictories'};
...
var author$project$Leaderboard$renderVictories = function (r) {
	return author$project$Leaderboard$numCol(r.victories);
};
				...
				]),
			{
				columns: _List_fromArray(
					[
						...
						header: A2(
							mdgriffith$elm_ui$Element$el,
							headerStyle(author$project$Leaderboard$SMatches),
							thRight('Matches')),
						view: author$project$Leaderboard$renderMatches,
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: A2(
						...
						header: A2(
							mdgriffith$elm_ui$Element$el,
							headerStyle(author$project$Leaderboard$SVictories),
							thRight('Victories')),
						view: author$project$Leaderboard$renderVictories,
						width: mdgriffith$elm_ui$Element$fill
					}
					]),
				data: A3(
